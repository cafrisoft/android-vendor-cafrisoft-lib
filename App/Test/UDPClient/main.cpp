...
int main(int argc, char* argv[]) {
    ...
    //std::shared_ptr<Socket::UDP::Client> client = Socket::UDP::Client::CreateObject("192.168.100.1", 9829);
    std::shared_ptr<Socket::UDP::Client> client = Socket::UDP::Client::CreateObject("192.168.100.73", 9829);
    assert(client);
