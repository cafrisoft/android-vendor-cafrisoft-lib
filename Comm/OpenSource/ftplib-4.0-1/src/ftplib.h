...
GLOBALREF int FtpConnect(const char *host, int portNum, netbuf **nControl);
...
GLOBALREF int FtpGetWithCB(const char* output, const char* path, char mode, netbuf* nControl, void* cbArg, Comm_NetUtils_FtpGetCallback cbfunc);
